...
func resourcePagerDutyServiceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	req, err := buildServiceStruct(d)
	if err != nil {
		return err
	}

	log.Printf("[INFO] Creating PagerDuty service %s", req.Name)

	service, err := client.CreateService(req)
	if err != nil {
		return err
	}
...
func resourcePagerDutyServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	return resource.Retry(2*time.Minute, func() *resource.RetryError {
		...
		if service.AutoResolveTimeout == nil {
			...
			d.Set("auto_resolve_timeout", strconv.Itoa(int(*service.AutoResolveTimeout)))
		}
		...
		if service.AcknowledgementTimeout == nil {
			...
			d.Set("acknowledgement_timeout", strconv.Itoa(int(*service.AcknowledgementTimeout)))
		}
...
func resourcePagerDutyServiceUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if _, err := client.UpdateService(req); err != nil {
		return err
	}
